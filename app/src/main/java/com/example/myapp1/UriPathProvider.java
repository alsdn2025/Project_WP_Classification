    ...
    public static String getRealPathFromURI(final Context context, final Uri uri) {
        ...
        if (DocumentsContract.isDocumentUri(context, uri)) {
            ...
            // MediaProvider
                ...
                String result = getDataColumn(context, contentUri, selection,
                        selectionArgs);
    ...
    public static String getDataColumn(Context context, Uri uri,
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                Log.e("UriPathProvider.getDataColumn - ", "cursor is null");
            }
        } catch (Exception e){
            Log.e("UriPathProvider.getDataColumn - ", e.getMessage());
        }finally {
            if (cursor != null)
                cursor.close();
        }
